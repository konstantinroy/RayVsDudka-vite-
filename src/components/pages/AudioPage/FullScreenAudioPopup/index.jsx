...
const Index = ({
  ...
  const rewindAudio = (e) => {
    const width = audioProgressLine.current.clientWidth;
  ...
  // console.log("lastChar: ", activeAudio.audioName.charAt(activeAudio.audioName.length - 1));
  ...
  return (
    <div className={styles.fullScreenAudioPopup}>
      ...
      ${activeAudio.audioName.length > 25 ? styles.animateAudioName : ""}
      `}
          >
